...
module.exports.run = (client, message, args) => {
    ...
    message.channel.send(botembed).then(message =>{
        ...
        botembed.addField("!help_moderation" , "Commande permettant de voir les commandes de modérations" )
        botembed.addField("!help_utilisateur" , "Commande permettant de voir les commandes pour les utilisateurs" )
