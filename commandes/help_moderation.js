...
module.exports.run = (client, message, args) => {
    ...
    message.channel.send(botembed).then(message =>{
        ...
        botembed.addField("!ban" , "Commande permettant de bannir un utilisateur ! (EX : !ban ZyGout Insulte a multiple reprise)" )
        botembed.addField("!kick" , "Commande permettant d\'expulser un utilisateur ! (EX : !kick @ZyGout Spam)" )
        botembed.addField("!clear" , "Commande permettant de supprimer des messages ! (EX : !clear 100) **MAX 100**" )
